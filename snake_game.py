# Simple snake game in python Juan Ramon
...
#Set up the screen
wn = turtle.Screen()
wn.title("Snake Game by Juan Ra")
wn.bgcolor("black")
...
while True:
    ...
    #Check for a colission with border
    ...
    #Check for a colission with food
    ...
    #Check for head colission with body segments
    for segment in segments:
